...
//     setSelectedQuotation(record); // Lưu lại thông tin quotation đang chọn
//     form.setFieldsValue(record); // Đặt giá trị của form bằng dữ liệu của record đang chọn
//     setShowModal(true); // Hiển thị modal để chỉnh sửa
//   };
...
//   const handleCancel = () => {
//     setShowModal(false);
//     setSelectedQuotation(null); // Đặt lại selectedQuotation khi đóng modal
//   };
