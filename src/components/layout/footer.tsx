...
const Footer = () => {
  return (
    <footer className="w-full bg-[#056839] mt-auto">
      <div className="w-[79.17%] tablet:w-[90%] phone:w-[90%] flex phone:flex-col justify-start items-start gap-[100px] phone:gap-[15px] mx-auto py-[5vw]">
